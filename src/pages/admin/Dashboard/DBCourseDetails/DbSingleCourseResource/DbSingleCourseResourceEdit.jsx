...
import DbSingleCourseResourceEditForm from "./DbSingleCourseResourceEditForm";
...
const DbSingleCourseResourceEdit = () => {
          ...
          <div className="course-card gap-5">
            <Box sx={{ width: "100%" }}>
              ...
              {/* <CustomTabPanel value={value} index={2}>
                ...
                <DbSingleCourseLessonEditForm />
              </CustomTabPanel> */}
              <CustomTabPanel value={value} index={3}>
                {/* <DbSingleCourseResource courseId={id} /> */}
                <DbSingleCourseResourceEditForm courseId={courseId}/>
              </CustomTabPanel>
...
export default DbSingleCourseResourceEdit;
